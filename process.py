...
1. 主线 (核心故事线): 
    ...
    - 评估标准
        1. **主线剧情是否清晰?**
            核心矛盾冲突简单易懂, 让观众无需理解能力即可看懂, 主要矛盾需集中于一处(或一人/一团体/一实体)
        2. **剧情节奏是否紧凑且脉络简单?**
            剧情不宜过度悬疑, 需符合短剧快节奏-通俗-简单-娱乐化-不宜严肃的基本要求, 剧情事件一环扣一环
        3. **逻辑是否自洽?**
            剧情前后呼应, 人物设定符合剧情背景且无违和感
        - 额外信息
            1. 在主线大纲分析阶段暂不考虑故事细节, 仅基于故事简介进行分析
            2. 在主线大纲分析阶段, 细节描写, 情感描写, 内心冲突等细节是不必要的, 你只需要对大纲进行简要分析即可
2. 人设 (角色设定): 
